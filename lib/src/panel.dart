...
class SlidingUpPanel extends StatefulWidget {
  ...
  /// The default visible state of the panel. If false, the panel will be hidden
  final bool defaultPanelVisible;
...
class _SlidingUpPanelState extends State<SlidingUpPanel> with SingleTickerProviderStateMixin {
  ...
  late bool _isPanelVisible = widget.defaultPanelVisible;
  ...
  //close the panel
  Future<void> _close() => _ac.fling(velocity: -1.0);

  //open the panel
  Future<void> _open() => _ac.fling();

  //hide the panel (completely offscreen)
  Future<void> _hide() => _ac.fling(velocity: -1.0).then((x) {
        setState(() {
  ...
  Future<void> _show() => _ac.fling(velocity: -1.0).then((x) {
        setState(() {
